...
if option == "Pengaruh Kondisi Cuaca":
    ...
    bar_width = 0.2  # Mengurangi lebar batang
    ...
    # Menambahkan ruang antar kelompok batang dengan memperbesar jarak antar ticks
    plt.tight_layout()  # Untuk mengatur layout agar lebih rapi
    st.pyplot(fig)
